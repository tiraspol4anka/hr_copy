<template>
    <div class="container">
        <b-row cols="1">
            <b-col>
                <h2 class="text-center  my-3 title_about">Информация</h2>
            </b-col>
            <b-col>
                <div class="separate">
        ...
        <b-row class="justify-content-md-center news-item"
            ...
            <b-col cols="12" md="6">
                <nuxt-link :to="`/informatsiya/${article.slug}/`">
                    <b-img :src="require(`~/assets/images/news/${article.img}`)" :title=article.alt fluid class="p-4">
                    </b-img>
                </nuxt-link>
            </b-col>
            <b-col cols="10" md="6" class="news_description">
                ...
                <nuxt-link :to="`/informatsiya/${article.slug}/`"><span><button
                            class="zak callme">Прочитать</button></span></nuxt-link>
            </b-col>
        </b-row>
...
<script>
    export default {
        async asyncData({ $content, params }) {
            ...
            const articles = await $content('informatsiya', params.slug)
                .sortBy("data")
