export const state = () => ({
    newsnew: [
            ...
            {
                id: 1,
                title: "Вакцинация трудовых мигрантов. Пошаговый план для работодателей.",
                date: "01.07.2021", 
               description: "Вакцинация трудовых мигрантов проводится по адресу:г.Москва, ул.Верхние Поля, д.54, стр.15.Режим работы с 8.00 – 20.00 г.Москва, п.Вороновское, Варшавское шоссе, 64-й километр, домовладение 1. Режим работы с 9.00-21.00 1. Для организации вакцинации пришлите свою заявку на адрес электронной почты Форма должна включать: наименование организации, адрес организации, ",
               image: "fe7.jpg",
               content: `<div class="row newsdetail">
                <div class= "col-md-2" >& nbsp;</div>
        <div class="col-md-8 news-detail">
            <h3>Как работает аутстаффинг персонала компании</h3>
            <p class="news-date">14.06.2020</p>"`
            },
            {
                id: 2,
...
export const getters = {
    getNewsById: (state) => (id) => {
        return state.newsnew.find(news => news.id == id)
    }
}